...
/**
 * This class is used to play rock-paper-scissors-lizard-spock
 * @author patrick gould
 * @version 1.0
 */
public class RPSLSpock {

     // Importing rand for the computer player
    ...
    /**
     *checks to see if the user pick is valid
     * @param pick These are the arguments used in the commend line
     * @return false if answer is null, else return pick
     */
    ...
    /**
     * This generates the computer players pick
     * @return returns computer pick
     */
     ...
     * @param c_pick this is the computer pick
     * @param h_pick this is the user, or human, pick
